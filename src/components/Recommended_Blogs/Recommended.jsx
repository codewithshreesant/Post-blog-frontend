...
function Recommended() {
  ...
  return (
    <div>
      <div>
        <h1 className="text-4xl md:text-5xl lg:text-4xl font-extrabold text-center text-purple-500 mt-6 mb-4 shadow-lg bg-gradient-to-r from-purple-200 via-purple-400 to-purple-600 p-4 rounded-lg">
          Recommended Blogs
        </h1>

      </div>
      <div className='grid grid-cols-[25vw_25vw_25vw] gap-8 justify-center'>
        {
          data && recommendPosts.map((post, index) => {
            return <div>
              ...
              <img src={post.image} alt="recommend post" className='w-[25vw] h-[50vh]' />
